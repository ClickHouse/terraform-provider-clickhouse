...
- `credentials` (Attributes) The credentials for BigQuery access. (see [below for nested schema](#nestedatt--source--bigquery--credentials))
...
- `credentials` (Attributes) The credentials for the Postgres instance. (see [below for nested schema](#nestedatt--source--postgres--credentials))
...
- `table_mappings` (Attributes List) Table mappings from Postgres source to ClickHouse destination. (see [below for nested schema](#nestedatt--source--postgres--table_mappings))
...
- `password` (String, Sensitive) The password for the Postgres instance.
