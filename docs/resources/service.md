...
- `password_wo` (String, Sensitive) Write-Only version of the Password attribute, to be used to set a password for the default user. One of either `password`, `password_wo` or `password_hash` must be specified.
