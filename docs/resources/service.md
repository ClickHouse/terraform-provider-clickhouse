...
- `tier` (String) Tier of the service: 'development', 'production'. Required for services using the Legacy ClickHouse Cloud Tiers, must be omitted for services using the new ClickHouse Cloud Tiers.
