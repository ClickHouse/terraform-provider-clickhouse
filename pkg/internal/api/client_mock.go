...
type ClientMock struct {
	...
	funcCreateDatabaseOrigin    string
	...
	funcDeleteDatabaseOrigin    string
	...
	funcGetGrantPrivilegeOrigin    string
	...
	funcGrantPrivilegeOrigin    string
	...
	funcRevokeGrantPrivilegeOrigin    string
...
type ClientMockCreateDatabaseExpectation struct {
	...
	expectationOrigins ClientMockCreateDatabaseExpectationOrigins
...
// ClientMockCreateDatabaseOrigins contains origins of expectations of the Client.CreateDatabase
type ClientMockCreateDatabaseExpectationOrigins struct {
	origin          string
	originCtx       string
	originServiceID string
	originDb        string
...
func (mmCreateDatabase *mClientMockCreateDatabase) Expect(ctx context.Context, serviceID string, db Database) *mClientMockCreateDatabase {
	...
	mmCreateDatabase.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmCreateDatabase *mClientMockCreateDatabase) ExpectCtxParam1(ctx context.Context) *mClientMockCreateDatabase {
	...
	mmCreateDatabase.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmCreateDatabase *mClientMockCreateDatabase) ExpectServiceIDParam2(serviceID string) *mClientMockCreateDatabase {
	...
	mmCreateDatabase.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmCreateDatabase *mClientMockCreateDatabase) ExpectDbParam3(db Database) *mClientMockCreateDatabase {
	...
	mmCreateDatabase.defaultExpectation.expectationOrigins.originDb = minimock.CallerInfo(1)
...
func (mmCreateDatabase *mClientMockCreateDatabase) Return(err error) *ClientMock {
	...
	mmCreateDatabase.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmCreateDatabase *mClientMockCreateDatabase) Set(f func(ctx context.Context, serviceID string, db Database) (err error)) *ClientMock {
	...
	mmCreateDatabase.mock.funcCreateDatabaseOrigin = minimock.CallerInfo(1)
	return mmCreateDatabase.mock
}
...
func (mmCreateDatabase *mClientMockCreateDatabase) When(ctx context.Context, serviceID string, db Database) *ClientMockCreateDatabaseExpectation {
	...
	expectation := &ClientMockCreateDatabaseExpectation{
		...
		expectationOrigins: ClientMockCreateDatabaseExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmCreateDatabase *mClientMockCreateDatabase) Times(n uint64) *mClientMockCreateDatabase {
	...
	mmCreateDatabase.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmCreateDatabase
}
...
func (mmCreateDatabase *ClientMock) CreateDatabase(ctx context.Context, serviceID string, db Database) (err error) {
	...
	if mmCreateDatabase.CreateDatabaseMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmCreateDatabase.t.Errorf("ClientMock.CreateDatabase got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreateDatabase.CreateDatabaseMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmCreateDatabase.t.Errorf("ClientMock.CreateDatabase got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreateDatabase.CreateDatabaseMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.db != nil && !minimock.Equal(*mm_want_ptrs.db, mm_got.db) {
				mmCreateDatabase.t.Errorf("ClientMock.CreateDatabase got unexpected parameter db, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreateDatabase.CreateDatabaseMock.defaultExpectation.expectationOrigins.originDb, *mm_want_ptrs.db, mm_got.db, minimock.Diff(*mm_want_ptrs.db, mm_got.db))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmCreateDatabase.t.Errorf("ClientMock.CreateDatabase got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmCreateDatabase.CreateDatabaseMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ClientMock) MinimockCreateDatabaseInspect() {
	for _, e := range m.CreateDatabaseMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.CreateDatabase at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.CreateDatabaseMock.defaultExpectation != nil && afterCreateDatabaseCounter < 1 {
		if m.CreateDatabaseMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClientMock.CreateDatabase at\n%s", m.CreateDatabaseMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClientMock.CreateDatabase at\n%s with params: %#v", m.CreateDatabaseMock.defaultExpectation.expectationOrigins.origin, *m.CreateDatabaseMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcCreateDatabase != nil && afterCreateDatabaseCounter < 1 {
		m.t.Errorf("Expected call to ClientMock.CreateDatabase at\n%s", m.funcCreateDatabaseOrigin)
	}
	...
	if !m.CreateDatabaseMock.invocationsDone() && afterCreateDatabaseCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.CreateDatabase at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.CreateDatabaseMock.expectedInvocations), m.CreateDatabaseMock.expectedInvocationsOrigin, afterCreateDatabaseCounter)
	}
}
...
func (mmCreateRole *mClientMockCreateRole) ExpectServiceIdParam2(serviceId string) *mClientMockCreateRole {
	...
	mmCreateRole.defaultExpectation.expectationOrigins.originServiceId = minimock.CallerInfo(1)
...
func (mmCreateRole *ClientMock) CreateRole(ctx context.Context, serviceId string, role Role) (rp1 *Role, err error) {
	...
	if mmCreateRole.CreateRoleMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.serviceId != nil && !minimock.Equal(*mm_want_ptrs.serviceId, mm_got.serviceId) {
				mmCreateRole.t.Errorf("ClientMock.CreateRole got unexpected parameter serviceId, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreateRole.CreateRoleMock.defaultExpectation.expectationOrigins.originServiceId, *mm_want_ptrs.serviceId, mm_got.serviceId, minimock.Diff(*mm_want_ptrs.serviceId, mm_got.serviceId))
			}

			if mm_want_ptrs.role != nil && !minimock.Equal(*mm_want_ptrs.role, mm_got.role) {
				mmCreateRole.t.Errorf("ClientMock.CreateRole got unexpected parameter role, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
type ClientMockCreateUserExpectation struct {
	...
	expectationOrigins ClientMockCreateUserExpectationOrigins
...
// ClientMockCreateUserOrigins contains origins of expectations of the Client.CreateUser
type ClientMockCreateUserExpectationOrigins struct {
	origin          string
	originCtx       string
	originServiceId string
	originUser      string
...
func (mmCreateUser *mClientMockCreateUser) ExpectServiceIdParam2(serviceId string) *mClientMockCreateUser {
	...
	mmCreateUser.defaultExpectation.expectationOrigins.originServiceId = minimock.CallerInfo(1)
...
func (mmCreateUser *mClientMockCreateUser) When(ctx context.Context, serviceId string, user User) *ClientMockCreateUserExpectation {
	...
	expectation := &ClientMockCreateUserExpectation{
		...
		expectationOrigins: ClientMockCreateUserExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmCreateUser *ClientMock) CreateUser(ctx context.Context, serviceId string, user User) (up1 *User, err error) {
	...
	if mmCreateUser.CreateUserMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmCreateUser.t.Errorf("ClientMock.CreateUser got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.serviceId != nil && !minimock.Equal(*mm_want_ptrs.serviceId, mm_got.serviceId) {
				mmCreateUser.t.Errorf("ClientMock.CreateUser got unexpected parameter serviceId, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreateUser.CreateUserMock.defaultExpectation.expectationOrigins.originServiceId, *mm_want_ptrs.serviceId, mm_got.serviceId, minimock.Diff(*mm_want_ptrs.serviceId, mm_got.serviceId))
			}

			if mm_want_ptrs.user != nil && !minimock.Equal(*mm_want_ptrs.user, mm_got.user) {
				mmCreateUser.t.Errorf("ClientMock.CreateUser got unexpected parameter user, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			mmCreateUser.t.Errorf("ClientMock.CreateUser got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *ClientMock) MinimockCreateUserInspect() {
	for _, e := range m.CreateUserMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.CreateUser at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.CreateUserMock.invocationsDone() && afterCreateUserCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.CreateUser at\n%s but found %d calls",
...
type ClientMockDeleteDatabaseExpectation struct {
	...
	expectationOrigins ClientMockDeleteDatabaseExpectationOrigins
...
// ClientMockDeleteDatabaseOrigins contains origins of expectations of the Client.DeleteDatabase
type ClientMockDeleteDatabaseExpectationOrigins struct {
	origin          string
	originCtx       string
	originServiceID string
	originName      string
...
func (mmDeleteDatabase *mClientMockDeleteDatabase) Expect(ctx context.Context, serviceID string, name string) *mClientMockDeleteDatabase {
	...
	mmDeleteDatabase.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmDeleteDatabase *mClientMockDeleteDatabase) ExpectCtxParam1(ctx context.Context) *mClientMockDeleteDatabase {
	...
	mmDeleteDatabase.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmDeleteDatabase *mClientMockDeleteDatabase) ExpectServiceIDParam2(serviceID string) *mClientMockDeleteDatabase {
	...
	mmDeleteDatabase.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmDeleteDatabase *mClientMockDeleteDatabase) ExpectNameParam3(name string) *mClientMockDeleteDatabase {
	...
	mmDeleteDatabase.defaultExpectation.expectationOrigins.originName = minimock.CallerInfo(1)
...
func (mmDeleteDatabase *mClientMockDeleteDatabase) Return(err error) *ClientMock {
	...
	mmDeleteDatabase.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmDeleteDatabase *mClientMockDeleteDatabase) Set(f func(ctx context.Context, serviceID string, name string) (err error)) *ClientMock {
	...
	mmDeleteDatabase.mock.funcDeleteDatabaseOrigin = minimock.CallerInfo(1)
	return mmDeleteDatabase.mock
}
...
func (mmDeleteDatabase *mClientMockDeleteDatabase) When(ctx context.Context, serviceID string, name string) *ClientMockDeleteDatabaseExpectation {
	...
	expectation := &ClientMockDeleteDatabaseExpectation{
		...
		expectationOrigins: ClientMockDeleteDatabaseExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmDeleteDatabase *mClientMockDeleteDatabase) Times(n uint64) *mClientMockDeleteDatabase {
	...
	mmDeleteDatabase.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmDeleteDatabase
}
...
func (mmDeleteDatabase *ClientMock) DeleteDatabase(ctx context.Context, serviceID string, name string) (err error) {
	...
	if mmDeleteDatabase.DeleteDatabaseMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmDeleteDatabase.t.Errorf("ClientMock.DeleteDatabase got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDeleteDatabase.DeleteDatabaseMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmDeleteDatabase.t.Errorf("ClientMock.DeleteDatabase got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDeleteDatabase.DeleteDatabaseMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.name != nil && !minimock.Equal(*mm_want_ptrs.name, mm_got.name) {
				mmDeleteDatabase.t.Errorf("ClientMock.DeleteDatabase got unexpected parameter name, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDeleteDatabase.DeleteDatabaseMock.defaultExpectation.expectationOrigins.originName, *mm_want_ptrs.name, mm_got.name, minimock.Diff(*mm_want_ptrs.name, mm_got.name))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmDeleteDatabase.t.Errorf("ClientMock.DeleteDatabase got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmDeleteDatabase.DeleteDatabaseMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ClientMock) MinimockDeleteDatabaseInspect() {
	for _, e := range m.DeleteDatabaseMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.DeleteDatabase at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.DeleteDatabaseMock.defaultExpectation != nil && afterDeleteDatabaseCounter < 1 {
		if m.DeleteDatabaseMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClientMock.DeleteDatabase at\n%s", m.DeleteDatabaseMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClientMock.DeleteDatabase at\n%s with params: %#v", m.DeleteDatabaseMock.defaultExpectation.expectationOrigins.origin, *m.DeleteDatabaseMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.DeleteDatabaseMock.invocationsDone() && afterDeleteDatabaseCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.DeleteDatabase at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.DeleteDatabaseMock.expectedInvocations), m.DeleteDatabaseMock.expectedInvocationsOrigin, afterDeleteDatabaseCounter)
	}
}
...
func (mmDeleteRole *mClientMockDeleteRole) ExpectServiceIDParam2(serviceID string) *mClientMockDeleteRole {
	...
	mmDeleteRole.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmDeleteRole *mClientMockDeleteRole) ExpectNameParam3(name string) *mClientMockDeleteRole {
	...
	mmDeleteRole.defaultExpectation.expectationOrigins.originName = minimock.CallerInfo(1)
...
func (mmDeleteRole *ClientMock) DeleteRole(ctx context.Context, serviceID string, name string) (err error) {
	...
	if mmDeleteRole.DeleteRoleMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmDeleteRole.t.Errorf("ClientMock.DeleteRole got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDeleteRole.DeleteRoleMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.name != nil && !minimock.Equal(*mm_want_ptrs.name, mm_got.name) {
				mmDeleteRole.t.Errorf("ClientMock.DeleteRole got unexpected parameter name, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDeleteRole.DeleteRoleMock.defaultExpectation.expectationOrigins.originName, *mm_want_ptrs.name, mm_got.name, minimock.Diff(*mm_want_ptrs.name, mm_got.name))
			}
...
type ClientMockDeleteUserExpectation struct {
	...
	expectationOrigins ClientMockDeleteUserExpectationOrigins
...
// ClientMockDeleteUserOrigins contains origins of expectations of the Client.DeleteUser
type ClientMockDeleteUserExpectationOrigins struct {
	origin          string
	originCtx       string
	originServiceID string
	originName      string
...
func (mmDeleteUser *mClientMockDeleteUser) ExpectServiceIDParam2(serviceID string) *mClientMockDeleteUser {
	...
	mmDeleteUser.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmDeleteUser *mClientMockDeleteUser) ExpectNameParam3(name string) *mClientMockDeleteUser {
	...
	mmDeleteUser.defaultExpectation.expectationOrigins.originName = minimock.CallerInfo(1)
...
func (mmDeleteUser *mClientMockDeleteUser) When(ctx context.Context, serviceID string, name string) *ClientMockDeleteUserExpectation {
	...
	expectation := &ClientMockDeleteUserExpectation{
		...
		expectationOrigins: ClientMockDeleteUserExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmDeleteUser *ClientMock) DeleteUser(ctx context.Context, serviceID string, name string) (err error) {
	...
	if mmDeleteUser.DeleteUserMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmDeleteUser.t.Errorf("ClientMock.DeleteUser got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmDeleteUser.t.Errorf("ClientMock.DeleteUser got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDeleteUser.DeleteUserMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.name != nil && !minimock.Equal(*mm_want_ptrs.name, mm_got.name) {
				mmDeleteUser.t.Errorf("ClientMock.DeleteUser got unexpected parameter name, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmDeleteUser.DeleteUserMock.defaultExpectation.expectationOrigins.originName, *mm_want_ptrs.name, mm_got.name, minimock.Diff(*mm_want_ptrs.name, mm_got.name))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmDeleteUser.t.Errorf("ClientMock.DeleteUser got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *ClientMock) MinimockDeleteUserInspect() {
	for _, e := range m.DeleteUserMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.DeleteUser at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.DeleteUserMock.invocationsDone() && afterDeleteUserCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.DeleteUser at\n%s but found %d calls",
...
type ClientMockGetDatabaseExpectation struct {
	...
	expectationOrigins ClientMockGetDatabaseExpectationOrigins
...
// ClientMockGetDatabaseOrigins contains origins of expectations of the Client.GetDatabase
type ClientMockGetDatabaseExpectationOrigins struct {
	origin          string
	originCtx       string
	originServiceID string
	originName      string
...
func (mmGetDatabase *mClientMockGetDatabase) Expect(ctx context.Context, serviceID string, name string) *mClientMockGetDatabase {
	...
	mmGetDatabase.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGetDatabase *mClientMockGetDatabase) ExpectCtxParam1(ctx context.Context) *mClientMockGetDatabase {
	...
	mmGetDatabase.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmGetDatabase *mClientMockGetDatabase) ExpectServiceIDParam2(serviceID string) *mClientMockGetDatabase {
	...
	mmGetDatabase.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmGetDatabase *mClientMockGetDatabase) ExpectNameParam3(name string) *mClientMockGetDatabase {
	...
	mmGetDatabase.defaultExpectation.expectationOrigins.originName = minimock.CallerInfo(1)
...
func (mmGetDatabase *mClientMockGetDatabase) Return(dp1 *Database, err error) *ClientMock {
	...
	mmGetDatabase.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGetDatabase *mClientMockGetDatabase) Set(f func(ctx context.Context, serviceID string, name string) (dp1 *Database, err error)) *ClientMock {
	...
	mmGetDatabase.mock.funcGetDatabaseOrigin = minimock.CallerInfo(1)
	return mmGetDatabase.mock
}
...
func (mmGetDatabase *mClientMockGetDatabase) When(ctx context.Context, serviceID string, name string) *ClientMockGetDatabaseExpectation {
	...
	expectation := &ClientMockGetDatabaseExpectation{
		...
		expectationOrigins: ClientMockGetDatabaseExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGetDatabase *mClientMockGetDatabase) Times(n uint64) *mClientMockGetDatabase {
	...
	mmGetDatabase.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGetDatabase
}
...
func (mmGetDatabase *ClientMock) GetDatabase(ctx context.Context, serviceID string, name string) (dp1 *Database, err error) {
	...
	if mmGetDatabase.GetDatabaseMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetDatabase.t.Errorf("ClientMock.GetDatabase got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetDatabase.GetDatabaseMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmGetDatabase.t.Errorf("ClientMock.GetDatabase got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetDatabase.GetDatabaseMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.name != nil && !minimock.Equal(*mm_want_ptrs.name, mm_got.name) {
				mmGetDatabase.t.Errorf("ClientMock.GetDatabase got unexpected parameter name, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetDatabase.GetDatabaseMock.defaultExpectation.expectationOrigins.originName, *mm_want_ptrs.name, mm_got.name, minimock.Diff(*mm_want_ptrs.name, mm_got.name))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetDatabase.t.Errorf("ClientMock.GetDatabase got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGetDatabase.GetDatabaseMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ClientMock) MinimockGetDatabaseInspect() {
	for _, e := range m.GetDatabaseMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.GetDatabase at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GetDatabaseMock.defaultExpectation != nil && afterGetDatabaseCounter < 1 {
		if m.GetDatabaseMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClientMock.GetDatabase at\n%s", m.GetDatabaseMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClientMock.GetDatabase at\n%s with params: %#v", m.GetDatabaseMock.defaultExpectation.expectationOrigins.origin, *m.GetDatabaseMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetDatabase != nil && afterGetDatabaseCounter < 1 {
		m.t.Errorf("Expected call to ClientMock.GetDatabase at\n%s", m.funcGetDatabaseOrigin)
	}

	if !m.GetDatabaseMock.invocationsDone() && afterGetDatabaseCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.GetDatabase at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GetDatabaseMock.expectedInvocations), m.GetDatabaseMock.expectedInvocationsOrigin, afterGetDatabaseCounter)
	}
}
...
type ClientMockGetGrantPrivilegeExpectation struct {
	...
	expectationOrigins ClientMockGetGrantPrivilegeExpectationOrigins
...
// ClientMockGetGrantPrivilegeOrigins contains origins of expectations of the Client.GetGrantPrivilege
type ClientMockGetGrantPrivilegeExpectationOrigins struct {
	origin                string
	originCtx             string
	originServiceID       string
	originAccessType      string
	originDatabase        string
	originTable           string
	originColumn          string
	originGranteeUserName string
	originGranteeRoleName string
}
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) Expect(ctx context.Context, serviceID string, accessType string, database *string, table *string, column *string, granteeUserName *string, granteeRoleName *string) *mClientMockGetGrantPrivilege {
	...
	mmGetGrantPrivilege.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) ExpectCtxParam1(ctx context.Context) *mClientMockGetGrantPrivilege {
	...
	mmGetGrantPrivilege.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) ExpectServiceIDParam2(serviceID string) *mClientMockGetGrantPrivilege {
	...
	mmGetGrantPrivilege.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) ExpectAccessTypeParam3(accessType string) *mClientMockGetGrantPrivilege {
	...
	mmGetGrantPrivilege.defaultExpectation.expectationOrigins.originAccessType = minimock.CallerInfo(1)
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) ExpectDatabaseParam4(database *string) *mClientMockGetGrantPrivilege {
	...
	mmGetGrantPrivilege.defaultExpectation.expectationOrigins.originDatabase = minimock.CallerInfo(1)
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) ExpectTableParam5(table *string) *mClientMockGetGrantPrivilege {
	...
	mmGetGrantPrivilege.defaultExpectation.expectationOrigins.originTable = minimock.CallerInfo(1)
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) ExpectColumnParam6(column *string) *mClientMockGetGrantPrivilege {
	...
	mmGetGrantPrivilege.defaultExpectation.expectationOrigins.originColumn = minimock.CallerInfo(1)
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) ExpectGranteeUserNameParam7(granteeUserName *string) *mClientMockGetGrantPrivilege {
	...
	mmGetGrantPrivilege.defaultExpectation.expectationOrigins.originGranteeUserName = minimock.CallerInfo(1)
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) ExpectGranteeRoleNameParam8(granteeRoleName *string) *mClientMockGetGrantPrivilege {
	...
	mmGetGrantPrivilege.defaultExpectation.expectationOrigins.originGranteeRoleName = minimock.CallerInfo(1)
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) Return(gp1 *GrantPrivilege, err error) *ClientMock {
	...
	mmGetGrantPrivilege.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) Set(f func(ctx context.Context, serviceID string, accessType string, database *string, table *string, column *string, granteeUserName *string, granteeRoleName *string) (gp1 *GrantPrivilege, err error)) *ClientMock {
	...
	mmGetGrantPrivilege.mock.funcGetGrantPrivilegeOrigin = minimock.CallerInfo(1)
	return mmGetGrantPrivilege.mock
}
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) When(ctx context.Context, serviceID string, accessType string, database *string, table *string, column *string, granteeUserName *string, granteeRoleName *string) *ClientMockGetGrantPrivilegeExpectation {
	...
	expectation := &ClientMockGetGrantPrivilegeExpectation{
		...
		expectationOrigins: ClientMockGetGrantPrivilegeExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGetGrantPrivilege *mClientMockGetGrantPrivilege) Times(n uint64) *mClientMockGetGrantPrivilege {
	...
	mmGetGrantPrivilege.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGetGrantPrivilege
}
...
func (mmGetGrantPrivilege *ClientMock) GetGrantPrivilege(ctx context.Context, serviceID string, accessType string, database *string, table *string, column *string, granteeUserName *string, granteeRoleName *string) (gp1 *GrantPrivilege, err error) {
	...
	if mmGetGrantPrivilege.GetGrantPrivilegeMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetGrantPrivilege.t.Errorf("ClientMock.GetGrantPrivilege got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantPrivilege.GetGrantPrivilegeMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmGetGrantPrivilege.t.Errorf("ClientMock.GetGrantPrivilege got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantPrivilege.GetGrantPrivilegeMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.accessType != nil && !minimock.Equal(*mm_want_ptrs.accessType, mm_got.accessType) {
				mmGetGrantPrivilege.t.Errorf("ClientMock.GetGrantPrivilege got unexpected parameter accessType, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantPrivilege.GetGrantPrivilegeMock.defaultExpectation.expectationOrigins.originAccessType, *mm_want_ptrs.accessType, mm_got.accessType, minimock.Diff(*mm_want_ptrs.accessType, mm_got.accessType))
			}

			if mm_want_ptrs.database != nil && !minimock.Equal(*mm_want_ptrs.database, mm_got.database) {
				mmGetGrantPrivilege.t.Errorf("ClientMock.GetGrantPrivilege got unexpected parameter database, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantPrivilege.GetGrantPrivilegeMock.defaultExpectation.expectationOrigins.originDatabase, *mm_want_ptrs.database, mm_got.database, minimock.Diff(*mm_want_ptrs.database, mm_got.database))
			}

			if mm_want_ptrs.table != nil && !minimock.Equal(*mm_want_ptrs.table, mm_got.table) {
				mmGetGrantPrivilege.t.Errorf("ClientMock.GetGrantPrivilege got unexpected parameter table, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantPrivilege.GetGrantPrivilegeMock.defaultExpectation.expectationOrigins.originTable, *mm_want_ptrs.table, mm_got.table, minimock.Diff(*mm_want_ptrs.table, mm_got.table))
			}

			if mm_want_ptrs.column != nil && !minimock.Equal(*mm_want_ptrs.column, mm_got.column) {
				mmGetGrantPrivilege.t.Errorf("ClientMock.GetGrantPrivilege got unexpected parameter column, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantPrivilege.GetGrantPrivilegeMock.defaultExpectation.expectationOrigins.originColumn, *mm_want_ptrs.column, mm_got.column, minimock.Diff(*mm_want_ptrs.column, mm_got.column))
			}

			if mm_want_ptrs.granteeUserName != nil && !minimock.Equal(*mm_want_ptrs.granteeUserName, mm_got.granteeUserName) {
				mmGetGrantPrivilege.t.Errorf("ClientMock.GetGrantPrivilege got unexpected parameter granteeUserName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantPrivilege.GetGrantPrivilegeMock.defaultExpectation.expectationOrigins.originGranteeUserName, *mm_want_ptrs.granteeUserName, mm_got.granteeUserName, minimock.Diff(*mm_want_ptrs.granteeUserName, mm_got.granteeUserName))
			}

			if mm_want_ptrs.granteeRoleName != nil && !minimock.Equal(*mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName) {
				mmGetGrantPrivilege.t.Errorf("ClientMock.GetGrantPrivilege got unexpected parameter granteeRoleName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantPrivilege.GetGrantPrivilegeMock.defaultExpectation.expectationOrigins.originGranteeRoleName, *mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName, minimock.Diff(*mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetGrantPrivilege.t.Errorf("ClientMock.GetGrantPrivilege got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGetGrantPrivilege.GetGrantPrivilegeMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ClientMock) MinimockGetGrantPrivilegeInspect() {
	for _, e := range m.GetGrantPrivilegeMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.GetGrantPrivilege at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GetGrantPrivilegeMock.defaultExpectation != nil && afterGetGrantPrivilegeCounter < 1 {
		if m.GetGrantPrivilegeMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClientMock.GetGrantPrivilege at\n%s", m.GetGrantPrivilegeMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClientMock.GetGrantPrivilege at\n%s with params: %#v", m.GetGrantPrivilegeMock.defaultExpectation.expectationOrigins.origin, *m.GetGrantPrivilegeMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetGrantPrivilege != nil && afterGetGrantPrivilegeCounter < 1 {
		m.t.Errorf("Expected call to ClientMock.GetGrantPrivilege at\n%s", m.funcGetGrantPrivilegeOrigin)
	}
	...
	if !m.GetGrantPrivilegeMock.invocationsDone() && afterGetGrantPrivilegeCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.GetGrantPrivilege at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GetGrantPrivilegeMock.expectedInvocations), m.GetGrantPrivilegeMock.expectedInvocationsOrigin, afterGetGrantPrivilegeCounter)
	}
}
...
type ClientMockGetGrantRoleExpectation struct {
	...
	expectationOrigins ClientMockGetGrantRoleExpectationOrigins
...
// ClientMockGetGrantRoleOrigins contains origins of expectations of the Client.GetGrantRole
type ClientMockGetGrantRoleExpectationOrigins struct {
	origin                string
	originCtx             string
	originServiceID       string
	originGrantedRoleName string
	originGranteeUserName string
	originGranteeRoleName string
}
...
func (mmGetGrantRole *mClientMockGetGrantRole) Expect(ctx context.Context, serviceID string, grantedRoleName string, granteeUserName *string, granteeRoleName *string) *mClientMockGetGrantRole {
	...
	mmGetGrantRole.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGetGrantRole *mClientMockGetGrantRole) ExpectCtxParam1(ctx context.Context) *mClientMockGetGrantRole {
	...
	mmGetGrantRole.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmGetGrantRole *mClientMockGetGrantRole) ExpectServiceIDParam2(serviceID string) *mClientMockGetGrantRole {
	...
	mmGetGrantRole.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmGetGrantRole *mClientMockGetGrantRole) ExpectGrantedRoleNameParam3(grantedRoleName string) *mClientMockGetGrantRole {
	...
	mmGetGrantRole.defaultExpectation.expectationOrigins.originGrantedRoleName = minimock.CallerInfo(1)
...
func (mmGetGrantRole *mClientMockGetGrantRole) ExpectGranteeUserNameParam4(granteeUserName *string) *mClientMockGetGrantRole {
	...
	mmGetGrantRole.defaultExpectation.expectationOrigins.originGranteeUserName = minimock.CallerInfo(1)
...
func (mmGetGrantRole *mClientMockGetGrantRole) ExpectGranteeRoleNameParam5(granteeRoleName *string) *mClientMockGetGrantRole {
	...
	mmGetGrantRole.defaultExpectation.expectationOrigins.originGranteeRoleName = minimock.CallerInfo(1)
...
func (mmGetGrantRole *mClientMockGetGrantRole) Return(gp1 *GrantRole, err error) *ClientMock {
	...
	mmGetGrantRole.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGetGrantRole *mClientMockGetGrantRole) Set(f func(ctx context.Context, serviceID string, grantedRoleName string, granteeUserName *string, granteeRoleName *string) (gp1 *GrantRole, err error)) *ClientMock {
	...
	mmGetGrantRole.mock.funcGetGrantRoleOrigin = minimock.CallerInfo(1)
	return mmGetGrantRole.mock
}
...
func (mmGetGrantRole *mClientMockGetGrantRole) When(ctx context.Context, serviceID string, grantedRoleName string, granteeUserName *string, granteeRoleName *string) *ClientMockGetGrantRoleExpectation {
	...
	expectation := &ClientMockGetGrantRoleExpectation{
		...
		expectationOrigins: ClientMockGetGrantRoleExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGetGrantRole *mClientMockGetGrantRole) Times(n uint64) *mClientMockGetGrantRole {
	...
	mmGetGrantRole.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGetGrantRole
}
...
func (mmGetGrantRole *ClientMock) GetGrantRole(ctx context.Context, serviceID string, grantedRoleName string, granteeUserName *string, granteeRoleName *string) (gp1 *GrantRole, err error) {
	...
	if mmGetGrantRole.GetGrantRoleMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetGrantRole.t.Errorf("ClientMock.GetGrantRole got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantRole.GetGrantRoleMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmGetGrantRole.t.Errorf("ClientMock.GetGrantRole got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantRole.GetGrantRoleMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.grantedRoleName != nil && !minimock.Equal(*mm_want_ptrs.grantedRoleName, mm_got.grantedRoleName) {
				mmGetGrantRole.t.Errorf("ClientMock.GetGrantRole got unexpected parameter grantedRoleName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantRole.GetGrantRoleMock.defaultExpectation.expectationOrigins.originGrantedRoleName, *mm_want_ptrs.grantedRoleName, mm_got.grantedRoleName, minimock.Diff(*mm_want_ptrs.grantedRoleName, mm_got.grantedRoleName))
			}

			if mm_want_ptrs.granteeUserName != nil && !minimock.Equal(*mm_want_ptrs.granteeUserName, mm_got.granteeUserName) {
				mmGetGrantRole.t.Errorf("ClientMock.GetGrantRole got unexpected parameter granteeUserName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantRole.GetGrantRoleMock.defaultExpectation.expectationOrigins.originGranteeUserName, *mm_want_ptrs.granteeUserName, mm_got.granteeUserName, minimock.Diff(*mm_want_ptrs.granteeUserName, mm_got.granteeUserName))
			}

			if mm_want_ptrs.granteeRoleName != nil && !minimock.Equal(*mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName) {
				mmGetGrantRole.t.Errorf("ClientMock.GetGrantRole got unexpected parameter granteeRoleName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetGrantRole.GetGrantRoleMock.defaultExpectation.expectationOrigins.originGranteeRoleName, *mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName, minimock.Diff(*mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetGrantRole.t.Errorf("ClientMock.GetGrantRole got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGetGrantRole.GetGrantRoleMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ClientMock) MinimockGetGrantRoleInspect() {
	for _, e := range m.GetGrantRoleMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.GetGrantRole at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GetGrantRoleMock.defaultExpectation != nil && afterGetGrantRoleCounter < 1 {
		if m.GetGrantRoleMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClientMock.GetGrantRole at\n%s", m.GetGrantRoleMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClientMock.GetGrantRole at\n%s with params: %#v", m.GetGrantRoleMock.defaultExpectation.expectationOrigins.origin, *m.GetGrantRoleMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGetGrantRole != nil && afterGetGrantRoleCounter < 1 {
		m.t.Errorf("Expected call to ClientMock.GetGrantRole at\n%s", m.funcGetGrantRoleOrigin)
	}

	if !m.GetGrantRoleMock.invocationsDone() && afterGetGrantRoleCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.GetGrantRole at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GetGrantRoleMock.expectedInvocations), m.GetGrantRoleMock.expectedInvocationsOrigin, afterGetGrantRoleCounter)
	}
}
...
func (mmGetRole *mClientMockGetRole) ExpectServiceIDParam2(serviceID string) *mClientMockGetRole {
	...
	mmGetRole.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmGetRole *mClientMockGetRole) ExpectNameParam3(name string) *mClientMockGetRole {
	...
	mmGetRole.defaultExpectation.expectationOrigins.originName = minimock.CallerInfo(1)
...
func (mmGetRole *ClientMock) GetRole(ctx context.Context, serviceID string, name string) (rp1 *Role, err error) {
	...
	if mmGetRole.GetRoleMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmGetRole.t.Errorf("ClientMock.GetRole got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetRole.GetRoleMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.name != nil && !minimock.Equal(*mm_want_ptrs.name, mm_got.name) {
				mmGetRole.t.Errorf("ClientMock.GetRole got unexpected parameter name, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetRole.GetRoleMock.defaultExpectation.expectationOrigins.originName, *mm_want_ptrs.name, mm_got.name, minimock.Diff(*mm_want_ptrs.name, mm_got.name))
			}
...
type ClientMockGetUserExpectation struct {
	...
	expectationOrigins ClientMockGetUserExpectationOrigins
...
// ClientMockGetUserOrigins contains origins of expectations of the Client.GetUser
type ClientMockGetUserExpectationOrigins struct {
	origin          string
	originCtx       string
	originServiceID string
	originName      string
...
func (mmGetUser *mClientMockGetUser) ExpectServiceIDParam2(serviceID string) *mClientMockGetUser {
	...
	mmGetUser.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmGetUser *mClientMockGetUser) When(ctx context.Context, serviceID string, name string) *ClientMockGetUserExpectation {
	...
	expectation := &ClientMockGetUserExpectation{
		...
		expectationOrigins: ClientMockGetUserExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGetUser *ClientMock) GetUser(ctx context.Context, serviceID string, name string) (up1 *User, err error) {
	...
	if mmGetUser.GetUserMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetUser.t.Errorf("ClientMock.GetUser got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmGetUser.t.Errorf("ClientMock.GetUser got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetUser.GetUserMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.name != nil && !minimock.Equal(*mm_want_ptrs.name, mm_got.name) {
				mmGetUser.t.Errorf("ClientMock.GetUser got unexpected parameter name, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			mmGetUser.t.Errorf("ClientMock.GetUser got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *ClientMock) MinimockGetUserInspect() {
	for _, e := range m.GetUserMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.GetUser at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.GetUserMock.invocationsDone() && afterGetUserCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.GetUser at\n%s but found %d calls",
...
type ClientMockGrantPrivilegeExpectation struct {
	...
	expectationOrigins ClientMockGrantPrivilegeExpectationOrigins
...
// ClientMockGrantPrivilegeOrigins contains origins of expectations of the Client.GrantPrivilege
type ClientMockGrantPrivilegeExpectationOrigins struct {
	origin               string
	originCtx            string
	originServiceId      string
	originGrantPrivilege string
}
...
func (mmGrantPrivilege *mClientMockGrantPrivilege) Expect(ctx context.Context, serviceId string, grantPrivilege GrantPrivilege) *mClientMockGrantPrivilege {
	...
	mmGrantPrivilege.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGrantPrivilege *mClientMockGrantPrivilege) ExpectCtxParam1(ctx context.Context) *mClientMockGrantPrivilege {
	...
	mmGrantPrivilege.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmGrantPrivilege *mClientMockGrantPrivilege) ExpectServiceIdParam2(serviceId string) *mClientMockGrantPrivilege {
	...
	mmGrantPrivilege.defaultExpectation.expectationOrigins.originServiceId = minimock.CallerInfo(1)
...
func (mmGrantPrivilege *mClientMockGrantPrivilege) ExpectGrantPrivilegeParam3(grantPrivilege GrantPrivilege) *mClientMockGrantPrivilege {
	...
	mmGrantPrivilege.defaultExpectation.expectationOrigins.originGrantPrivilege = minimock.CallerInfo(1)
...
func (mmGrantPrivilege *mClientMockGrantPrivilege) Return(gp1 *GrantPrivilege, err error) *ClientMock {
	...
	mmGrantPrivilege.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGrantPrivilege *mClientMockGrantPrivilege) Set(f func(ctx context.Context, serviceId string, grantPrivilege GrantPrivilege) (gp1 *GrantPrivilege, err error)) *ClientMock {
	...
	mmGrantPrivilege.mock.funcGrantPrivilegeOrigin = minimock.CallerInfo(1)
	return mmGrantPrivilege.mock
}
...
func (mmGrantPrivilege *mClientMockGrantPrivilege) When(ctx context.Context, serviceId string, grantPrivilege GrantPrivilege) *ClientMockGrantPrivilegeExpectation {
	...
	expectation := &ClientMockGrantPrivilegeExpectation{
		...
		expectationOrigins: ClientMockGrantPrivilegeExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGrantPrivilege *mClientMockGrantPrivilege) Times(n uint64) *mClientMockGrantPrivilege {
	...
	mmGrantPrivilege.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGrantPrivilege
}
...
func (mmGrantPrivilege *ClientMock) GrantPrivilege(ctx context.Context, serviceId string, grantPrivilege GrantPrivilege) (gp1 *GrantPrivilege, err error) {
	...
	if mmGrantPrivilege.GrantPrivilegeMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGrantPrivilege.t.Errorf("ClientMock.GrantPrivilege got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGrantPrivilege.GrantPrivilegeMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.serviceId != nil && !minimock.Equal(*mm_want_ptrs.serviceId, mm_got.serviceId) {
				mmGrantPrivilege.t.Errorf("ClientMock.GrantPrivilege got unexpected parameter serviceId, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGrantPrivilege.GrantPrivilegeMock.defaultExpectation.expectationOrigins.originServiceId, *mm_want_ptrs.serviceId, mm_got.serviceId, minimock.Diff(*mm_want_ptrs.serviceId, mm_got.serviceId))
			}

			if mm_want_ptrs.grantPrivilege != nil && !minimock.Equal(*mm_want_ptrs.grantPrivilege, mm_got.grantPrivilege) {
				mmGrantPrivilege.t.Errorf("ClientMock.GrantPrivilege got unexpected parameter grantPrivilege, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGrantPrivilege.GrantPrivilegeMock.defaultExpectation.expectationOrigins.originGrantPrivilege, *mm_want_ptrs.grantPrivilege, mm_got.grantPrivilege, minimock.Diff(*mm_want_ptrs.grantPrivilege, mm_got.grantPrivilege))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGrantPrivilege.t.Errorf("ClientMock.GrantPrivilege got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGrantPrivilege.GrantPrivilegeMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ClientMock) MinimockGrantPrivilegeInspect() {
	for _, e := range m.GrantPrivilegeMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.GrantPrivilege at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GrantPrivilegeMock.defaultExpectation != nil && afterGrantPrivilegeCounter < 1 {
		if m.GrantPrivilegeMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClientMock.GrantPrivilege at\n%s", m.GrantPrivilegeMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClientMock.GrantPrivilege at\n%s with params: %#v", m.GrantPrivilegeMock.defaultExpectation.expectationOrigins.origin, *m.GrantPrivilegeMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGrantPrivilege != nil && afterGrantPrivilegeCounter < 1 {
		m.t.Errorf("Expected call to ClientMock.GrantPrivilege at\n%s", m.funcGrantPrivilegeOrigin)
	}

	if !m.GrantPrivilegeMock.invocationsDone() && afterGrantPrivilegeCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.GrantPrivilege at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.GrantPrivilegeMock.expectedInvocations), m.GrantPrivilegeMock.expectedInvocationsOrigin, afterGrantPrivilegeCounter)
	}
}
...
type ClientMockGrantRoleExpectation struct {
	...
	expectationOrigins ClientMockGrantRoleExpectationOrigins
...
// ClientMockGrantRoleOrigins contains origins of expectations of the Client.GrantRole
type ClientMockGrantRoleExpectationOrigins struct {
	origin          string
	originCtx       string
	originServiceId string
	originGrantRole string
}
...
func (mmGrantRole *mClientMockGrantRole) Expect(ctx context.Context, serviceId string, grantRole GrantRole) *mClientMockGrantRole {
	...
	mmGrantRole.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmGrantRole *mClientMockGrantRole) ExpectCtxParam1(ctx context.Context) *mClientMockGrantRole {
	...
	mmGrantRole.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmGrantRole *mClientMockGrantRole) ExpectServiceIdParam2(serviceId string) *mClientMockGrantRole {
	...
	mmGrantRole.defaultExpectation.expectationOrigins.originServiceId = minimock.CallerInfo(1)
...
func (mmGrantRole *mClientMockGrantRole) ExpectGrantRoleParam3(grantRole GrantRole) *mClientMockGrantRole {
	...
	mmGrantRole.defaultExpectation.expectationOrigins.originGrantRole = minimock.CallerInfo(1)
...
func (mmGrantRole *mClientMockGrantRole) Return(gp1 *GrantRole, err error) *ClientMock {
	...
	mmGrantRole.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmGrantRole *mClientMockGrantRole) Set(f func(ctx context.Context, serviceId string, grantRole GrantRole) (gp1 *GrantRole, err error)) *ClientMock {
	...
	mmGrantRole.mock.funcGrantRoleOrigin = minimock.CallerInfo(1)
	return mmGrantRole.mock
}
...
func (mmGrantRole *mClientMockGrantRole) When(ctx context.Context, serviceId string, grantRole GrantRole) *ClientMockGrantRoleExpectation {
	...
	expectation := &ClientMockGrantRoleExpectation{
		...
		expectationOrigins: ClientMockGrantRoleExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmGrantRole *mClientMockGrantRole) Times(n uint64) *mClientMockGrantRole {
	...
	mmGrantRole.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmGrantRole
}
...
func (mmGrantRole *ClientMock) GrantRole(ctx context.Context, serviceId string, grantRole GrantRole) (gp1 *GrantRole, err error) {
	...
	if mmGrantRole.GrantRoleMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGrantRole.t.Errorf("ClientMock.GrantRole got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGrantRole.GrantRoleMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.serviceId != nil && !minimock.Equal(*mm_want_ptrs.serviceId, mm_got.serviceId) {
				mmGrantRole.t.Errorf("ClientMock.GrantRole got unexpected parameter serviceId, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGrantRole.GrantRoleMock.defaultExpectation.expectationOrigins.originServiceId, *mm_want_ptrs.serviceId, mm_got.serviceId, minimock.Diff(*mm_want_ptrs.serviceId, mm_got.serviceId))
			}

			if mm_want_ptrs.grantRole != nil && !minimock.Equal(*mm_want_ptrs.grantRole, mm_got.grantRole) {
				mmGrantRole.t.Errorf("ClientMock.GrantRole got unexpected parameter grantRole, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGrantRole.GrantRoleMock.defaultExpectation.expectationOrigins.originGrantRole, *mm_want_ptrs.grantRole, mm_got.grantRole, minimock.Diff(*mm_want_ptrs.grantRole, mm_got.grantRole))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGrantRole.t.Errorf("ClientMock.GrantRole got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmGrantRole.GrantRoleMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ClientMock) MinimockGrantRoleInspect() {
	for _, e := range m.GrantRoleMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.GrantRole at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.GrantRoleMock.defaultExpectation != nil && afterGrantRoleCounter < 1 {
		if m.GrantRoleMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClientMock.GrantRole at\n%s", m.GrantRoleMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClientMock.GrantRole at\n%s with params: %#v", m.GrantRoleMock.defaultExpectation.expectationOrigins.origin, *m.GrantRoleMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGrantRole != nil && afterGrantRoleCounter < 1 {
		m.t.Errorf("Expected call to ClientMock.GrantRole at\n%s", m.funcGrantRoleOrigin)
	}
...
// ClientMockRevokeGrantPrivilegeOrigins contains origins of expectations of the Client.RevokeGrantPrivilege
type ClientMockRevokeGrantPrivilegeExpectationOrigins struct {
	origin                string
	originCtx             string
	originServiceID       string
	originAccessType      string
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) Expect(ctx context.Context, serviceID string, accessType string, database *string, table *string, column *string, granteeUserName *string, granteeRoleName *string) *mClientMockRevokeGrantPrivilege {
	...
	mmRevokeGrantPrivilege.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) ExpectCtxParam1(ctx context.Context) *mClientMockRevokeGrantPrivilege {
	...
	mmRevokeGrantPrivilege.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) ExpectServiceIDParam2(serviceID string) *mClientMockRevokeGrantPrivilege {
	...
	mmRevokeGrantPrivilege.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) ExpectAccessTypeParam3(accessType string) *mClientMockRevokeGrantPrivilege {
	...
	mmRevokeGrantPrivilege.defaultExpectation.expectationOrigins.originAccessType = minimock.CallerInfo(1)
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) ExpectDatabaseParam4(database *string) *mClientMockRevokeGrantPrivilege {
	...
	mmRevokeGrantPrivilege.defaultExpectation.expectationOrigins.originDatabase = minimock.CallerInfo(1)
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) ExpectTableParam5(table *string) *mClientMockRevokeGrantPrivilege {
	...
	mmRevokeGrantPrivilege.defaultExpectation.expectationOrigins.originTable = minimock.CallerInfo(1)
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) ExpectColumnParam6(column *string) *mClientMockRevokeGrantPrivilege {
	...
	mmRevokeGrantPrivilege.defaultExpectation.expectationOrigins.originColumn = minimock.CallerInfo(1)
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) ExpectGranteeUserNameParam7(granteeUserName *string) *mClientMockRevokeGrantPrivilege {
	...
	mmRevokeGrantPrivilege.defaultExpectation.expectationOrigins.originGranteeUserName = minimock.CallerInfo(1)
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) ExpectGranteeRoleNameParam8(granteeRoleName *string) *mClientMockRevokeGrantPrivilege {
	...
	mmRevokeGrantPrivilege.defaultExpectation.expectationOrigins.originGranteeRoleName = minimock.CallerInfo(1)
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) Return(err error) *ClientMock {
	...
	mmRevokeGrantPrivilege.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) Set(f func(ctx context.Context, serviceID string, accessType string, database *string, table *string, column *string, granteeUserName *string, granteeRoleName *string) (err error)) *ClientMock {
	...
	mmRevokeGrantPrivilege.mock.funcRevokeGrantPrivilegeOrigin = minimock.CallerInfo(1)
	return mmRevokeGrantPrivilege.mock
}
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) When(ctx context.Context, serviceID string, accessType string, database *string, table *string, column *string, granteeUserName *string, granteeRoleName *string) *ClientMockRevokeGrantPrivilegeExpectation {
	...
	expectation := &ClientMockRevokeGrantPrivilegeExpectation{
		...
		expectationOrigins: ClientMockRevokeGrantPrivilegeExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmRevokeGrantPrivilege *mClientMockRevokeGrantPrivilege) Times(n uint64) *mClientMockRevokeGrantPrivilege {
	...
	mmRevokeGrantPrivilege.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmRevokeGrantPrivilege
}
...
func (mmRevokeGrantPrivilege *ClientMock) RevokeGrantPrivilege(ctx context.Context, serviceID string, accessType string, database *string, table *string, column *string, granteeUserName *string, granteeRoleName *string) (err error) {
	...
	mmRevokeGrantPrivilege.t.Helper()
	...
	if mmRevokeGrantPrivilege.RevokeGrantPrivilegeMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmRevokeGrantPrivilege.t.Errorf("ClientMock.RevokeGrantPrivilege got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantPrivilege.RevokeGrantPrivilegeMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmRevokeGrantPrivilege.t.Errorf("ClientMock.RevokeGrantPrivilege got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantPrivilege.RevokeGrantPrivilegeMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.accessType != nil && !minimock.Equal(*mm_want_ptrs.accessType, mm_got.accessType) {
				mmRevokeGrantPrivilege.t.Errorf("ClientMock.RevokeGrantPrivilege got unexpected parameter accessType, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantPrivilege.RevokeGrantPrivilegeMock.defaultExpectation.expectationOrigins.originAccessType, *mm_want_ptrs.accessType, mm_got.accessType, minimock.Diff(*mm_want_ptrs.accessType, mm_got.accessType))
			}

			if mm_want_ptrs.database != nil && !minimock.Equal(*mm_want_ptrs.database, mm_got.database) {
				mmRevokeGrantPrivilege.t.Errorf("ClientMock.RevokeGrantPrivilege got unexpected parameter database, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantPrivilege.RevokeGrantPrivilegeMock.defaultExpectation.expectationOrigins.originDatabase, *mm_want_ptrs.database, mm_got.database, minimock.Diff(*mm_want_ptrs.database, mm_got.database))
			}

			if mm_want_ptrs.table != nil && !minimock.Equal(*mm_want_ptrs.table, mm_got.table) {
				mmRevokeGrantPrivilege.t.Errorf("ClientMock.RevokeGrantPrivilege got unexpected parameter table, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantPrivilege.RevokeGrantPrivilegeMock.defaultExpectation.expectationOrigins.originTable, *mm_want_ptrs.table, mm_got.table, minimock.Diff(*mm_want_ptrs.table, mm_got.table))
			}

			if mm_want_ptrs.column != nil && !minimock.Equal(*mm_want_ptrs.column, mm_got.column) {
				mmRevokeGrantPrivilege.t.Errorf("ClientMock.RevokeGrantPrivilege got unexpected parameter column, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantPrivilege.RevokeGrantPrivilegeMock.defaultExpectation.expectationOrigins.originColumn, *mm_want_ptrs.column, mm_got.column, minimock.Diff(*mm_want_ptrs.column, mm_got.column))
			}

			if mm_want_ptrs.granteeUserName != nil && !minimock.Equal(*mm_want_ptrs.granteeUserName, mm_got.granteeUserName) {
				mmRevokeGrantPrivilege.t.Errorf("ClientMock.RevokeGrantPrivilege got unexpected parameter granteeUserName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantPrivilege.RevokeGrantPrivilegeMock.defaultExpectation.expectationOrigins.originGranteeUserName, *mm_want_ptrs.granteeUserName, mm_got.granteeUserName, minimock.Diff(*mm_want_ptrs.granteeUserName, mm_got.granteeUserName))
			}

			if mm_want_ptrs.granteeRoleName != nil && !minimock.Equal(*mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName) {
				mmRevokeGrantPrivilege.t.Errorf("ClientMock.RevokeGrantPrivilege got unexpected parameter granteeRoleName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantPrivilege.RevokeGrantPrivilegeMock.defaultExpectation.expectationOrigins.originGranteeRoleName, *mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName, minimock.Diff(*mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmRevokeGrantPrivilege.t.Errorf("ClientMock.RevokeGrantPrivilege got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmRevokeGrantPrivilege.RevokeGrantPrivilegeMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ClientMock) MinimockRevokeGrantPrivilegeInspect() {
	for _, e := range m.RevokeGrantPrivilegeMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.RevokeGrantPrivilege at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.RevokeGrantPrivilegeMock.defaultExpectation != nil && afterRevokeGrantPrivilegeCounter < 1 {
		if m.RevokeGrantPrivilegeMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClientMock.RevokeGrantPrivilege at\n%s", m.RevokeGrantPrivilegeMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClientMock.RevokeGrantPrivilege at\n%s with params: %#v", m.RevokeGrantPrivilegeMock.defaultExpectation.expectationOrigins.origin, *m.RevokeGrantPrivilegeMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.RevokeGrantPrivilegeMock.invocationsDone() && afterRevokeGrantPrivilegeCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.RevokeGrantPrivilege at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.RevokeGrantPrivilegeMock.expectedInvocations), m.RevokeGrantPrivilegeMock.expectedInvocationsOrigin, afterRevokeGrantPrivilegeCounter)
	}
}
...
type ClientMockRevokeGrantRoleExpectation struct {
	...
	expectationOrigins ClientMockRevokeGrantRoleExpectationOrigins
...
// ClientMockRevokeGrantRoleOrigins contains origins of expectations of the Client.RevokeGrantRole
type ClientMockRevokeGrantRoleExpectationOrigins struct {
	origin                string
	originCtx             string
	originServiceID       string
	originGrantedRoleName string
...
func (mmRevokeGrantRole *mClientMockRevokeGrantRole) Expect(ctx context.Context, serviceID string, grantedRoleName string, granteeUserName *string, granteeRoleName *string) *mClientMockRevokeGrantRole {
	...
	mmRevokeGrantRole.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmRevokeGrantRole *mClientMockRevokeGrantRole) ExpectCtxParam1(ctx context.Context) *mClientMockRevokeGrantRole {
	...
	mmRevokeGrantRole.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmRevokeGrantRole *mClientMockRevokeGrantRole) ExpectServiceIDParam2(serviceID string) *mClientMockRevokeGrantRole {
	...
	mmRevokeGrantRole.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmRevokeGrantRole *mClientMockRevokeGrantRole) ExpectGrantedRoleNameParam3(grantedRoleName string) *mClientMockRevokeGrantRole {
	...
	mmRevokeGrantRole.defaultExpectation.expectationOrigins.originGrantedRoleName = minimock.CallerInfo(1)
...
func (mmRevokeGrantRole *mClientMockRevokeGrantRole) ExpectGranteeUserNameParam4(granteeUserName *string) *mClientMockRevokeGrantRole {
	...
	mmRevokeGrantRole.defaultExpectation.expectationOrigins.originGranteeUserName = minimock.CallerInfo(1)
...
func (mmRevokeGrantRole *mClientMockRevokeGrantRole) ExpectGranteeRoleNameParam5(granteeRoleName *string) *mClientMockRevokeGrantRole {
	...
	mmRevokeGrantRole.defaultExpectation.expectationOrigins.originGranteeRoleName = minimock.CallerInfo(1)
...
func (mmRevokeGrantRole *mClientMockRevokeGrantRole) Return(err error) *ClientMock {
	...
	mmRevokeGrantRole.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmRevokeGrantRole *mClientMockRevokeGrantRole) Set(f func(ctx context.Context, serviceID string, grantedRoleName string, granteeUserName *string, granteeRoleName *string) (err error)) *ClientMock {
	...
	mmRevokeGrantRole.mock.funcRevokeGrantRoleOrigin = minimock.CallerInfo(1)
	return mmRevokeGrantRole.mock
}
...
func (mmRevokeGrantRole *mClientMockRevokeGrantRole) When(ctx context.Context, serviceID string, grantedRoleName string, granteeUserName *string, granteeRoleName *string) *ClientMockRevokeGrantRoleExpectation {
	...
	expectation := &ClientMockRevokeGrantRoleExpectation{
		...
		expectationOrigins: ClientMockRevokeGrantRoleExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmRevokeGrantRole *mClientMockRevokeGrantRole) Times(n uint64) *mClientMockRevokeGrantRole {
	...
	mmRevokeGrantRole.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmRevokeGrantRole
}
...
func (mmRevokeGrantRole *ClientMock) RevokeGrantRole(ctx context.Context, serviceID string, grantedRoleName string, granteeUserName *string, granteeRoleName *string) (err error) {
	...
	if mmRevokeGrantRole.RevokeGrantRoleMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmRevokeGrantRole.t.Errorf("ClientMock.RevokeGrantRole got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantRole.RevokeGrantRoleMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmRevokeGrantRole.t.Errorf("ClientMock.RevokeGrantRole got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantRole.RevokeGrantRoleMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.grantedRoleName != nil && !minimock.Equal(*mm_want_ptrs.grantedRoleName, mm_got.grantedRoleName) {
				mmRevokeGrantRole.t.Errorf("ClientMock.RevokeGrantRole got unexpected parameter grantedRoleName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantRole.RevokeGrantRoleMock.defaultExpectation.expectationOrigins.originGrantedRoleName, *mm_want_ptrs.grantedRoleName, mm_got.grantedRoleName, minimock.Diff(*mm_want_ptrs.grantedRoleName, mm_got.grantedRoleName))
			}

			if mm_want_ptrs.granteeUserName != nil && !minimock.Equal(*mm_want_ptrs.granteeUserName, mm_got.granteeUserName) {
				mmRevokeGrantRole.t.Errorf("ClientMock.RevokeGrantRole got unexpected parameter granteeUserName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantRole.RevokeGrantRoleMock.defaultExpectation.expectationOrigins.originGranteeUserName, *mm_want_ptrs.granteeUserName, mm_got.granteeUserName, minimock.Diff(*mm_want_ptrs.granteeUserName, mm_got.granteeUserName))
			}

			if mm_want_ptrs.granteeRoleName != nil && !minimock.Equal(*mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName) {
				mmRevokeGrantRole.t.Errorf("ClientMock.RevokeGrantRole got unexpected parameter granteeRoleName, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmRevokeGrantRole.RevokeGrantRoleMock.defaultExpectation.expectationOrigins.originGranteeRoleName, *mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName, minimock.Diff(*mm_want_ptrs.granteeRoleName, mm_got.granteeRoleName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmRevokeGrantRole.t.Errorf("ClientMock.RevokeGrantRole got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmRevokeGrantRole.RevokeGrantRoleMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ClientMock) MinimockRevokeGrantRoleInspect() {
	for _, e := range m.RevokeGrantRoleMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.RevokeGrantRole at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.RevokeGrantRoleMock.defaultExpectation != nil && afterRevokeGrantRoleCounter < 1 {
		if m.RevokeGrantRoleMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClientMock.RevokeGrantRole at\n%s", m.RevokeGrantRoleMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClientMock.RevokeGrantRole at\n%s with params: %#v", m.RevokeGrantRoleMock.defaultExpectation.expectationOrigins.origin, *m.RevokeGrantRoleMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcRevokeGrantRole != nil && afterRevokeGrantRoleCounter < 1 {
		m.t.Errorf("Expected call to ClientMock.RevokeGrantRole at\n%s", m.funcRevokeGrantRoleOrigin)
	}

	if !m.RevokeGrantRoleMock.invocationsDone() && afterRevokeGrantRoleCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.RevokeGrantRole at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.RevokeGrantRoleMock.expectedInvocations), m.RevokeGrantRoleMock.expectedInvocationsOrigin, afterRevokeGrantRoleCounter)
	}
}
...
type ClientMockSyncDatabaseExpectation struct {
	...
	expectationOrigins ClientMockSyncDatabaseExpectationOrigins
...
// ClientMockSyncDatabaseOrigins contains origins of expectations of the Client.SyncDatabase
type ClientMockSyncDatabaseExpectationOrigins struct {
	origin          string
	originCtx       string
	originServiceID string
	originDb        string
...
func (mmSyncDatabase *mClientMockSyncDatabase) Expect(ctx context.Context, serviceID string, db Database) *mClientMockSyncDatabase {
	...
	mmSyncDatabase.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmSyncDatabase *mClientMockSyncDatabase) ExpectCtxParam1(ctx context.Context) *mClientMockSyncDatabase {
	...
	mmSyncDatabase.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmSyncDatabase *mClientMockSyncDatabase) ExpectServiceIDParam2(serviceID string) *mClientMockSyncDatabase {
	...
	mmSyncDatabase.defaultExpectation.expectationOrigins.originServiceID = minimock.CallerInfo(1)
...
func (mmSyncDatabase *mClientMockSyncDatabase) ExpectDbParam3(db Database) *mClientMockSyncDatabase {
	...
	mmSyncDatabase.defaultExpectation.expectationOrigins.originDb = minimock.CallerInfo(1)
...
func (mmSyncDatabase *mClientMockSyncDatabase) Return(err error) *ClientMock {
	...
	mmSyncDatabase.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmSyncDatabase *mClientMockSyncDatabase) Set(f func(ctx context.Context, serviceID string, db Database) (err error)) *ClientMock {
	...
	mmSyncDatabase.mock.funcSyncDatabaseOrigin = minimock.CallerInfo(1)
	return mmSyncDatabase.mock
}
...
func (mmSyncDatabase *mClientMockSyncDatabase) When(ctx context.Context, serviceID string, db Database) *ClientMockSyncDatabaseExpectation {
	...
	expectation := &ClientMockSyncDatabaseExpectation{
		...
		expectationOrigins: ClientMockSyncDatabaseExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmSyncDatabase *mClientMockSyncDatabase) Times(n uint64) *mClientMockSyncDatabase {
	...
	mmSyncDatabase.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmSyncDatabase
}
...
func (mmSyncDatabase *ClientMock) SyncDatabase(ctx context.Context, serviceID string, db Database) (err error) {
	...
	if mmSyncDatabase.SyncDatabaseMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmSyncDatabase.t.Errorf("ClientMock.SyncDatabase got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSyncDatabase.SyncDatabaseMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.serviceID != nil && !minimock.Equal(*mm_want_ptrs.serviceID, mm_got.serviceID) {
				mmSyncDatabase.t.Errorf("ClientMock.SyncDatabase got unexpected parameter serviceID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSyncDatabase.SyncDatabaseMock.defaultExpectation.expectationOrigins.originServiceID, *mm_want_ptrs.serviceID, mm_got.serviceID, minimock.Diff(*mm_want_ptrs.serviceID, mm_got.serviceID))
			}

			if mm_want_ptrs.db != nil && !minimock.Equal(*mm_want_ptrs.db, mm_got.db) {
				mmSyncDatabase.t.Errorf("ClientMock.SyncDatabase got unexpected parameter db, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSyncDatabase.SyncDatabaseMock.defaultExpectation.expectationOrigins.originDb, *mm_want_ptrs.db, mm_got.db, minimock.Diff(*mm_want_ptrs.db, mm_got.db))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmSyncDatabase.t.Errorf("ClientMock.SyncDatabase got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmSyncDatabase.SyncDatabaseMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ClientMock) MinimockSyncDatabaseInspect() {
	for _, e := range m.SyncDatabaseMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ClientMock.SyncDatabase at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.SyncDatabaseMock.defaultExpectation != nil && afterSyncDatabaseCounter < 1 {
		if m.SyncDatabaseMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to ClientMock.SyncDatabase at\n%s", m.SyncDatabaseMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to ClientMock.SyncDatabase at\n%s with params: %#v", m.SyncDatabaseMock.defaultExpectation.expectationOrigins.origin, *m.SyncDatabaseMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.SyncDatabaseMock.invocationsDone() && afterSyncDatabaseCounter > 0 {
		m.t.Errorf("Expected %d calls to ClientMock.SyncDatabase at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.SyncDatabaseMock.expectedInvocations), m.SyncDatabaseMock.expectedInvocationsOrigin, afterSyncDatabaseCounter)
	}
}
